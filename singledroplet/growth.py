...
class dropletdynamics:
    def __init__(self,**kwargs):
        ...
        self.__antibiotics = {'zmic':kwargs.get('antibiotics_zmic',0.002),'kappa':kwargs.get('antibiotics_kappa',2.),'gamma':kwargs.get('antibiotics_gamma',10.),'yielddecay':kwargs.get('antibiotics_yielddecay',10.)}
    ...
    def dxdt(self,tt,xx):
        ...
        # thus, model growth rate as product of 
        #    * standard Michaelis-Menten kinetics dependent on nutrient concentration and
        #    * a sigmoid curve in antibiotic concentration of growth rate (=beta), interpolating between 1 and -gamma (reaching 0 at a concentration of zMIC)
...
def main():
    ...
    parser_interaction.add_argument("-Y","--antibiotics_yielddecay", type=float, default=10.)
    parser_interaction.add_argument("-K","--nutrients_ks",           type=float, default=0.1)
