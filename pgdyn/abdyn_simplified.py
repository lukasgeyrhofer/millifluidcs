...
parser.add_argument("-l","--lambda",default=1.5,type=float)
parser.add_argument("-e","--eta",default=1e-1,type=float)
...
d = gc.TimeIntegrator(dynamics = dyn,initialconditions = np.array([args.bacteria,args.antibiotics]),step = args.integrationstep)
